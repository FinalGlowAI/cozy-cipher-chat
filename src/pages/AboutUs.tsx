          ...
          <div className="space-y-6 text-muted-foreground">
            ...
            <section>
              ...
              <p>
                ...
                functions. Our open-source approach means that security experts worldwide can verify
                and contribute to our codebase, ensuring the highest standards of security and
                transparency.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Open source - complete transparency for security verification</li>
