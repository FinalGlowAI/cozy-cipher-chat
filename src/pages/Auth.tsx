...
const Auth = () => {
  ...
  // FIX: forgot password handler using existing send-password-reset Edge Function
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Always show success — the Edge Function never reveals if email exists
      toast.success("If this email is registered, a reset link has been sent.");
      setIsForgotPassword(false);
      trackEvent('password_reset_requested');
    } catch (err: any) {
      // Still show success to avoid email enumeration on the client side
      toast.success("If this email is registered, a reset link has been sent.");
    } finally {
      setLoading(false);
    }
  ...
  const getCardDescription = () => {
    ...
    return isSignUp ? "Sign up to get started" : "Sign in to your account";
  };
